        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                while (checkBox1.Checked == true && button3.Text == "Stop...")
                {
                    ...
                    var scriptRocket = @"document.querySelector('.rocket-button button').click();";
                    chromiumWebBrowser1.ExecuteScriptAsync(scriptRocket);
                    var scriptAlert = @"document.querySelector('.alert-button button').click();";
                    chromiumWebBrowser1.ExecuteScriptAsync(scriptAlert);
